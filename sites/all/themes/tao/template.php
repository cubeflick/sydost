...
function tao_preprocess_page(&$vars) {
  ...
  $strFrontPageJs =  '
	(function($) {
		...
		//$(".view-offers a.yLink:first").attr("href",$(".view-offers .views-field-path span:first").text());
		//$(".view-offers a.yLink:last").attr("href",$(".view-offers .views-field-path span:last").text());
  		
  		$(".view-offers a.yLink:first").click(function(){
  			externalUrl = $(".view-offers .views-field-path span:first").text();
  			if(externalUrl.indexOf("http") > -1)
  			{
  				if(externalUrl.substring(0,1) == "/")
  				{
  					window.location.href = decodeURIComponent(externalUrl.substring(1));
  				}
  				else
  				{
  		...
  		$(".view-offers a.yLink:last").click(function(){
  			externalUrl = $(".view-offers .views-field-path span:last").text();
  ...
  drupal_add_js($strFrontPageJs,array('type' => 'inline', 'scope' => 'footer'));
}
...
function tao_process_page(&$variables) {
 ...
 */
function tao_preprocess_views_view_fields(&$vars) {
// 	$view = $vars['view'];
